<header id="home"
    ...
    <div class="max-w-full mx-auto px-6 lg:px-0 relative z-20 ml-0 lg:ml-16">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 w-full pt-8 sm:pt-14 md:pt-20 lg:pt-0">
            <!-- Text di kiri -->
            <div class="w-full max-w-full ml-0 md:ml-0 lg:ml-10 mt-14 sm:mt-4 md:mt-6 lg:mt-10 xl:-mt-12">
                ...
                transform hover:scale-105 transition duration-300 ease-in-out">
                    <img src="/assets/img/iwa.png" alt="Icon"
                        class="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 object-contain">
                    <span>Pesan Sekarang</span>
                </button>
            </div>

            <!-- Gambar kanan (Hanya tampil di Laptop / Desktop ke atas) -->
            <div class="hidden lg:flex w-full max-w-full justify-end">
