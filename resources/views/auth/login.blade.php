...
<body class="bg-slate-900 min-h-screen flex items-center justify-center p-4 antialiased relative overflow-hidden font-sans">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-2xl border border-white/20 relative overflow-hidden">
